...
const Nav2 = (props) => {
    ...
    return (
        <header className='mx-auto z-10 fixed w-full bg-putih drop-shadow-5xl'>
            <div className=" flex items-center justify-between px-16 py-8 border-b border-keempat">
                <div className=" flex">
                    <NavLink to='/dashboardPMB'><h1 className=' tracking-wider font-Cinzel font-black text-utama text-xl'>Warung<span className=' text-kedua'>Ku</span></h1></NavLink>
                </div>
                            ...
                            <div className=' bg-putih drop-shadow-6xl rounded-b-lg block font-DMSans px-4 py-3'>
                                <div className=" flex items-start justify-center gap-4">
                                    ...
                                    <div className=" flex flex-col">
                                        ...
                                        <NavLink to='/EditProfile'><div className=" flex items-center text-start gap-1 group/2 decoration-utama">
                                            <Pencil/>
                                ...
                                <div className=" flex flex-col pt-5 gap-2">
                                    ...
                                    <NavLink to='/EditProfile'><div className=" flex items-center gap-3 py-1 hover:bg-utama rounded group/1">
                                        <User3/>
                                        <h1 className=' text-sm group-hover/1:text-putih text-ketiga'>Akun Saya</h1>
                                    </div></NavLink>
                                    <NavLink to='/PesananSaya'><div className=" flex items-center gap-3 py-1 hover:bg-utama rounded group/1">
                                        <Wislist/>
                                        <h1 className=' text-sm group-hover/1:text-putih text-ketiga'>Pesanan Saya</h1>
                                    </div></NavLink>
            ...
            <div className=" flex items-center py-3 px-16">
                <h1 className=' font-DMSans font-bold text-base'>{props.kategori}</h1>
            </div>
        </header>
    )
}
